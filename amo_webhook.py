...
# 🔹 AmoCRM данные (рекомендуется хранить в переменных окружения)
...
def webhook():
    # Если нужно, добавьте здесь проверку секретного ключа, чтобы не принимать запросы от сторонних лиц.
    process_leads()
